...
type MagicLink[CustomCreateArgs, CustomReadResponse any] struct {
...
func NewMagicLink[CustomCreateArgs, CustomReadResponse any](setupCtx context.Context, config Config[CustomCreateArgs, CustomReadResponse]) (MagicLink[CustomCreateArgs, CustomReadResponse], error) {
	var m MagicLink[CustomCreateArgs, CustomReadResponse]
	...
	var store Storage[CustomCreateArgs, CustomReadResponse]
	store = config.Store
	if store == nil {
		store = NewMemoryStorage[CustomCreateArgs, CustomReadResponse]()
	}

	m = MagicLink[CustomCreateArgs, CustomReadResponse]{
		Store:             store,
...
func (m MagicLink[CustomCreateArgs, CustomReadResponse]) JWKSHandler() http.Handler {
...
func (m MagicLink[CustomCreateArgs, CustomReadResponse]) NewLink(ctx context.Context, args CreateArgs[CustomCreateArgs]) (CreateResponse, error) {
	err := args.Valid()
	if err != nil {
...
func (m MagicLink[CustomCreateArgs, CustomReadResponse]) MagicLinkHandler() http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if m.customRedirector != nil {
			args := RedirectorArgs[CustomCreateArgs, CustomReadResponse]{
...
func (m MagicLink[CustomCreateArgs, CustomReadResponse]) HandleMagicLink(ctx context.Context, secret string) (jwtB64 string, response ReadResponse[CustomCreateArgs, CustomReadResponse], err error) {
...
func (m MagicLink[CustomCreateArgs, CustomReadResponse]) handleError(err error, suggestedResponseCode int, request *http.Request, writer http.ResponseWriter) {
